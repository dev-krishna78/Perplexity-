...
const Dashboard = () => {
  ...
  return (
    <main className='min-h-screen w-full bg-[#07090f] p-3 text-white md:p-5'>
      <section className='mx-auto flex h-[calc(100vh-1.5rem)] w-full gap-4 rounded-3xl border   p-1 md:h-[calc(100vh-2.5rem)] md:gap-6 md:p-1 border-none scrollbar-hide'>
        <aside className='hidden h-full w-72 shrink-0 rounded-3xl border overflow-y-auto scrollbar-hide bg-[#184ecb] p-4 md:flex md:flex-col'>
          ...
          <div className='space-y-2 '>
            ...
            {Object.values(chats).map((chat,index) => (
             ...
             <button className='bg-red-500 h-5 w-5'>
              delete
            </button>
          </div>
        </aside>
